...
main_card.innerHTML = data.Search.map(el => {   //mapping datas to page
...
input1.addEventListener("input", () => {    //find method 
    ...
    let indexTitle = data.Search.filter((el, index) => {
...
btnClear.addEventListener("click", (e) => {  //clear input
    e.preventDefault();
    input1.value = "";
...
// main_card.addEventListener("mouseover", (e)=>{
//     console.log(e);
// });
